...
<head>
  ...
  <link rel="stylesheet" href="/assets/dist/css/adminlte.min.css">
    ...
    <link rel="icon" type="image/png" href="/img/Ethydco.png">
</head>
<style>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
               <a href="{{route('logout')}}" class="nav-link" style="color: rgb(235, 86, 86)">Logout</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
      <img src="/img/Ethydco.png" alt="Ethydco" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Ethydco</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/storage/{{Auth::user()->profile_pic}}" class="img-circle elevation-2" alt="User Image" style="width: 40px;height:40px;">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="{{route('view.profile', Auth::user()->id)}}" class="nav-link">
              ...
              <li class="nav-item">
                <a href="{{route('view.departments')}}" class="nav-link">
              ...
              @if(Auth::user()->name != "Admin")
              <li class="nav-item">
                <a href="{{route('user.role.specific',Auth::user()->role_id)}}" class="nav-link">
                  <i class="nav-icon fas fa-table"></i>
                  <p>
                    Assessment
                  </p>
...
{{--
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            {{-- <h1 class="m-0">{{Auth::user()->role->name}}</h1> --}}
            <h1 class="m-0">@yield('title')</h1>
            <hr>
            <p class="m-0">@yield('title2')</p>
          </div><!-- /.col -->
  ...
  <footer class="main-footer">
    <strong>Ethydco Competency Test</strong>
